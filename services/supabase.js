...
function mapSupabaseDataToAppFormat(logData) {
  ...
  return {
    ...
    pos_1kv_connected: logData.beam_energy?.pos1kv?.connected ?? null,
    ...
    neg_1kv_connected: logData.beam_energy?.neg1kv?.connected ?? null,
    ...
    pos_20kv_connected: logData.beam_energy?.pos20kv?.connected ?? null,
    ...
    pos_3kv_connected: logData.beam_energy?.pos3kv?.connected ?? null,
