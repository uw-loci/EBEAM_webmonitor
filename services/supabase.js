...
function mapSupabaseDataToAppFormat(logData) {
  ...
  return {
    ...
    machine_status_temps: logData.machine_status?.STATUS_TEMPS ?? null,
    machine_status_pressure_1e_4: logData.machine_status?.STATUS_PRESSURE_1E_4 ?? null,
    machine_status_interlocks: logData.machine_status?.STATUS_INTERLOCKS ?? null,
    machine_status_hv_panel: logData.machine_status?.STATUS_HV_PANEL ?? null,
    machine_status_pressure_1e_6: logData.machine_status?.STATUS_PRESSURE_1E_6 ?? null,
    machine_status_hvps_nominal: logData.machine_status?.STATUS_HVPS_NOMINAL ?? null,
    machine_status_bcon: logData.machine_status?.STATUS_BCON ?? null,
    machine_status_cathodes: logData.machine_status?.STATUS_CATHODES ?? null,
    machine_status_beams_ready: logData.machine_status?.STATUS_BEAMS_READY ?? null,
    machine_status_beams_on: logData.machine_status?.STATUS_BEAMS_ON ?? null,
    ...
    pos_1kv_output: logData.beam_energy?.pos1kv?.output ?? null,
    pos_1kv_set: logData.beam_energy?.pos1kv?.set_v ?? null,
    pos_1kv_hv: logData.beam_energy?.pos1kv?.meas_v ?? null,
    pos_1kv_i: logData.beam_energy?.pos1kv?.meas_i ?? null,
    neg_1kv_output: logData.beam_energy?.neg1kv?.output ?? null,
    neg_1kv_set: logData.beam_energy?.neg1kv?.set_v ?? null,
    neg_1kv_hv: logData.beam_energy?.neg1kv?.meas_v ?? null,
    neg_1kv_i: logData.beam_energy?.neg1kv?.meas_i ?? null,
    pos_20kv_output: logData.beam_energy?.pos20kv?.output ?? null,
    pos_20kv_set: logData.beam_energy?.pos20kv?.set_v ?? null,
    pos_20kv_hv: logData.beam_energy?.pos20kv?.meas_v ?? null,
    pos_20kv_i: logData.beam_energy?.pos20kv?.meas_i ?? null,
    pos_3kv_output: logData.beam_energy?.pos3kv?.output ?? null,
    pos_3kv_set: logData.beam_energy?.pos3kv?.set_v ?? null,
    pos_3kv_hv: logData.beam_energy?.pos3kv?.meas_v ?? null,
    pos_3kv_i: logData.beam_energy?.pos3kv?.meas_i ?? null,
  };
}
