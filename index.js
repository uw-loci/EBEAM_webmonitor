     ...
     switch(logType) {
         case "DEBUG: GUI updated with pressure":
           ...
           if (pressureMatch && pressureMatch[1]) {
               ...
               // 5 minutes
               if (difference <= 300){
                  console.log("pressure: ", pressureMbar)
...
app.get('/', async (req, res) => {
 try {
   ...
   let pressure = null;
   if (data && data.differenceTimestamp != null && data.differenceTimestamp <= 300) {
